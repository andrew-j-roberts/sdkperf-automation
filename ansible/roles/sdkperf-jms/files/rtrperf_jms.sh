...
TMP_VM_MEM="-Xms512m -Xmx1024m"
[ -z $SOLACE_SDKPERF_VM_MEM ] || TMP_VM_MEM=$SOLACE_SDKPERF_VM_MEM
SOLACE_VM_ARGS="$SOLACE_VM_ARGS $TMP_VM_MEM"
# ---------------------------------------------
...
CLASSPATH="$CLASSPATH" java $SOLACE_VM_ARGS com.solacesystems.pubsub.sdkperf.SDKPerf_java -api=JMS -tm=rtrperf "$@"
